/* kontrolle console: echo
	echo -n philipp | sha256sum -> OK
	echo -n philipp | sha512sum -> OK
*/
...
int main(const int argc, const char * const argv[])
{
    ...
    // crypto_hash_sha256(hash, reinterpret_cast<const unsigned char*>(message), message_length);
